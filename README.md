...
This project demonstrates deploying the 2048 game on Kubernetes, exposing it via an Ingress resource using **ingress-nginx**, and then migrating to **ingress-haproxy**. It showcases how to switch Ingress controllers in a k8s cluster.
